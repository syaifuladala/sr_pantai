...
<div class="container">
    <table class="table" width="100%">
        <tr>
            <td width="85%">
                <h5><b>Data Persebaran Covid (kecamatan)</b></h5>
            </td>
    ...
    <table class="table" id="myTable">
        <tr class="header">
            ...
            <th width="15%">Meninggal</th>
            <th width="15%">Sembuh</th>
            <th width="15%">Aksi</th>
        </tr>
        ...
        <tr class="myTable-content">
            ...
            <td>{{$data->sembuh}}</td>
            <td>
                <a href="{{url('/covid/'.$data->id)}}"><button type="button" class="btn btn-success">Edit</button></a>
                <a href="{{url('/covid/delete/'.$data->id)}}"><button type="button" class="btn btn-danger">Hapus</button></a>
            </td>
        </tr>
        @endforeach
    </table>
...
<!-- Tambah Data Modal -->
<form action="{{url('/covid/create')}}" method="POST">
    @csrf
